...
const HomeSectionOneProducts = () => {
  ...
  const fetchSectionProducts = async () => {
    ...
    try {
      ...
      toast.error("Failed to load Section 1 products");
    } finally {
      setLoading(false);
    }
  };
          ...
          <table className="w-full min-w-[900px] border-collapse text-sm">
            ...
            <tbody className="divide-y divide-cream-50 font-body">
              {loading ? (
                ...
                <tr>
                  <td colSpan="6" className="p-10 text-center text-text-muted italic">No products found in Section 1.</td>
                </tr>
              )}
            </tbody>
          </table>
...
export default HomeSectionOneProducts;