...
const HomeNewNoteworthyForm = () => {
    ...
    if (isEdit) {
      const fetchData = async () => {
        try {
          ...
          // 🟢 Changed Endpoint to home-new-noteworthy
          ...
          navigate('/admin/new-and-noteworthy'); // 🟢 Changed Route
        } finally {
  ...
  const handleSubmit = async (e, actionType) => {
    ...
    try {
      ...
      let res;
      // 🟢 Changed Endpoints to home-new-noteworthy
      if (isEdit) {
        res = await axios.put(`${API_URL}/home-new-noteworthy/update/${id}`, payload);
      } else {
        res = await axios.post(`${API_URL}/home-new-noteworthy/save`, payload);
      }
