...
const AddArtist = () => {
  ...
  const [formData, setFormData] = useState({
    first_name: '',
    last_name: '',
    role: '', // 🟢 Image ke hisab se role field add ki gayi hai
    origin: '',
  });
  ...
  const handleSubmit = async (e, actionType) => {
    ...
    setLoading(true);
    const toastId = toast.loading("Saving artist...");
    ...
    try {
      ...
      const res = await axios.post(`${API_URL}/artists/save`, data, {
      ...
      if (res.data.status) {
        ...
        if (actionType === 'back') {
          ...
          setFormData({ first_name: '', last_name: '', role: '', origin: '' });
          setProfile('');
          setImageFile(null);
        }
      }
  ...
  return (
    <div className="bg-cream-50 min-h-screen font-body text-text-main pb-10">
      ...
      <div className="bg-primary sticky  px-6 py-3 shadow-md flex items-center justify-between">
      ...
      <div className="max-w-6xl mx-auto p-6 mt-4">
        <form className="bg-white rounded border border-cream-200 shadow-sm overflow-hidden">
          ...
          <div className="bg-cream-100 px-6 py-3 border-b border-cream-200">
             <h2 className="text-[11px] font-bold text-text-muted uppercase tracking-wider font-montserrat">Artist Information</h2>
          </div>
          ...
          <div className="p-8 space-y-6">
            ...
            {/* Role - 🟢 Extra field as per image */}
            <div className="grid grid-cols-12 gap-4 items-center border-b border-cream-50 pb-4">
              <label className="col-span-3 text-right text-[11px] font-bold text-text-muted uppercase font-montserrat">Role</label>
              <div className="col-span-9">
            ...
            <div className="flex justify-center items-center gap-4 pt-8 border-t mt-4 font-montserrat">
              ...
              <button type="button" onClick={() => navigate('/admin/artists')} className="bg-white border border-cream-200 text-text-main px-8 py-2.5 rounded font-bold text-[10px] uppercase shadow-sm hover:bg-cream-50 active:scale-95 transition-all flex items-center gap-2">
