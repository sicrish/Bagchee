...
const EditAuthorsPublishers = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const res = await axios.get(`${API_URL}/authors-publishers/get`); 
  ...
  const config = useMemo(() => ({
    ...
    height: 450,
    theme: "default",
    placeholder: 'Write about authors and publishers...',
...
export default EditAuthorsPublishers;