...
import { CurrencyContext } from '../../../../context/CurrencyContext.jsx'; // ⚠️ Check Path
    ...
    <section id='sale-today' className="py-10 md:py-16 bg-cream-50 font-body">
      <div className="max-w-[1400px] mx-auto px-4 group/section">
        ...
        <div className="relative">
            ...
            {products.map((item) => {
                // 🟢 FIX: Access 'product' object (Populated)
                ...
                // 🛠️ Price Calculation
                // Assuming 'price' is the selling price. If oldPrice/real_price exists and is higher, show it.
                ...
                return (
                    <Link to={`/product/${book._id}`} key={item._id} className="bg-cream-100 hover:shadow-xl transition-all group cursor-pointer flex flex-col block rounded-lg overflow-hidden">
                    ...
                    <div className="relative aspect-[2/3] overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 w-full bg-primary/90 backdrop-blur-sm text-white text-center py-2 translate-y-full group-hover:translate-y-0 transition-transform duration-300 hidden md:block">
                        ...
                        <div className="mt-2 md:mt-3 flex flex-wrap md:flex-nowrap items-center justify-between gap-1">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                <button 
                                    ...
                                    title="Add to Cart"
                                    onClick={(e) => { e.preventDefault(); /* Cart */ }}
                                >
